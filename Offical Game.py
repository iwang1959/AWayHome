...
mc = Animation("mc2.png",8,game,196/4,176/2)
mc.resizeBy(100)
mc.moveTo(50,700)
...
ms = Image("mine_shaft.png",game)
ms.resizeTo(900,700)
cutscreen = Animation("sc.png",8,game,1350/3,1200/3)
cutscreen.resizeTo(900,700)
gem = Animation("gem.png",6,game,90/3,104/2)
gem.moveTo(800,600)
